...
def main():
    ...
    with open('../../bitcoin/blocks/blk00000.dat', 'rb') as blockFile:
    ...
    pub = pybtc.PublicKey('038b3103094269744d696e746572062f503253482f2cfabe6d6dc86df3910e13fa4fbb0c14debfe8404de5e47e3f4c06b51a503fba96b98125e00100000000000000136575318a920000000000006600000000000000')
    addr = pybtc.Address(pub).address
    print(addr)
