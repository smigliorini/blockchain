...
def b58encode(v):
	...
	result = ''
	while long_value >= b58chars_len:
		div, mod = divmod(long_value, b58chars_len)
...
def b58decode(v, length):
	...
	for (i, c) in enumerate(v[::-1]):
		long_value += b58chars.find(c) * (b58chars_len**i)
...
if __name__ == '__main__':
	...
	encoded = b58encode(x)
	print(encoded, '19TbMSWwHvnxAKy12iNm3KdbGfzfaMFViT') #address output
